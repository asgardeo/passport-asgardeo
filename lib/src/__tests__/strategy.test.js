...
describe("Strategy", function () {
  ...
  it("should redirect without redirect URI", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&scope=openid&state=" +
  ...
  it("should redirect with response mode parameter", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&response_mode=form_post&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&state=" +
            encodeURIComponent(state),
        );
        expect(state).to.have.length(24);
        expect(
  ...
  it("should redirect with prompt parameter set to extension value", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&prompt=x-example&state=" +
            encodeURIComponent(state),
        );
        expect(state).to.have.length(24);
        expect(
  ...
  it("should redirect with display parameter set to extension value", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&display=x-example&state=" +
            encodeURIComponent(state),
        );
        expect(state).to.have.length(24);
        expect(
  ...
  it("should redirect with UI locales parameter", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&ui_locales=fr-CA%20fr%20en&state=" +
            encodeURIComponent(state),
        );
        expect(state).to.have.length(24);
        expect(
  ...
  it("should redirect with max age parameter", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&max_age=86400&state=" +
            encodeURIComponent(state),
        );
        expect(state).to.have.length(24);
        expect(
  ...
  it("should redirect with authentication context class reference values parameter", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&acr_values=urn%3Amace%3Aincommon%3Aiap%3Asilver&state=" +
            encodeURIComponent(state),
        );
        expect(state).to.have.length(24);
        expect(
  ...
  it("should redirect with ID token hint parameter", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&id_token_hint=eyJh.ewogImlzcyI6ICJo.ggW8hZ1E&state=" +
            encodeURIComponent(state),
        );
        expect(state).to.have.length(24);
        expect(
  ...
  it("should redirect with nonce parameter", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&nonce=" +
  ...
  it("should redirect with claims parameter", function (done) {
    ...
    chai.passport
      ...
      .redirect(function (url) {
        ...
        expect(url).to.equal(
          "https://server.example.com/authorize?response_type=code&client_id=s6BhdRkqt3&redirect_uri=https%3A%2F%2Fclient.example.org%2Fcb&scope=openid&claims=%7B%22userinfo%22%3A%7B%22email%22%3Anull%2C%22email_verified%22%3Anull%7D%7D&state=" +
            encodeURIComponent(state),
        );
        expect(state).to.have.length(24);
        expect(
  ...
  it("should authenticate request", function (done) {
    ...
    sinon
      ...
      .yieldsAsync(null, "SlAV32hkKG", "8xLOxBtZp8", {
        token_type: "Bearer",
        expires_in: 3600,
        id_token: jws.sign({
          header: { alg: "HS256" },
    ...
    sinon.stub(strategy._oauth2, "get").yieldsAsync(
      null,
      JSON.stringify({
        sub: "248289761001",
        name: "Jane Doe",
    ...
    chai.passport
      ...
      .success(function (user, info) {
        ...
        expect(
          strategy._oauth2.getOAuthAccessToken.getCall(0).args[0],
        ).to.equal("SplxlOBeZQQYbYS6WxSbIA");
        expect(
          strategy._oauth2.getOAuthAccessToken.getCall(0).args[1],
        ).to.deep.equal({
  ...
  it("should error when state store yeilds an error attempting to store state", function (done) {
    ...
    sinon
      .stub(strategy._stateStore, "store")
      .yieldsAsync(new Error("something went wrong"));
  ...
  it("should error when receiving an error with text content from token endpoint", function (done) {
    ...
    sinon
      .stub(strategy._oauth2, "getOAuthAccessToken")
      .yieldsAsync({ statusCode: 500, data: "something went wrong" });
  ...
  it("should error when userinfo request is unauthorized", function (done) {
    ...
    sinon
      ...
      .yieldsAsync({ statusCode: 401, data: "" });
